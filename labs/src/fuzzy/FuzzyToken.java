...
//returning the elements in fuzzyset with value different from zero
    ...
    public String toString() {
        ...
        return "<" + df.format(fuzzyValues.get(FuzzyValue.NL)) + ", " +
                df.format(fuzzyValues.get(FuzzyValue.NM)) + ", " +
                df.format(fuzzyValues.get(FuzzyValue.ZR)) + ", " +
                df.format(fuzzyValues.get(FuzzyValue.PM)) + ", " +
                df.format(fuzzyValues.get(FuzzyValue.PL)) + ">";
    }
}